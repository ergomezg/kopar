...
| Token Name | Hex Value | CSS Variable | Tailwind Class | Role & Usage |
|---|---|---|---|---|
...
### 5.4. Quick Actions Grid (`QuickActions.tsx`)
...
### 5.5. Activity & Transaction Rows (`RecentActivity.tsx`, `ActividadTab.tsx`)
...
### 5.6. Budget Progress & Category Breakdown (`PresupuestoTab.tsx`)
...
### 5.7. Bottom Navigation Bar (`BottomNavigation.tsx`)
...
- **DO NOT add redundant hero eyebrows or multiple labels saying the same thing.**
